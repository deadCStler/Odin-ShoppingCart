    ...
    <>
      ...
      <div className={BrandCSS.text}>
        <p>
          ...
          established MiniBuy with its headquarters in Seoul, South Korea,
          aiming to cater to the diverse needs of young consumers worldwide.
        </p>
        ...
        <p>
          As MiniBuy expanded its reach globally, it recognized the importance
          of redefining affordability and introduced the concept of
          &quot;value-driven consumption&quot; to the retail landscape. To stay
          relevant to its youthful audience, MiniBuy continually innovates
          through collaborations with popular brands, cutting-edge designs, and
        ...
        <p>
          ...
          From bustling metropolises like Tokyo and Shanghai to cosmopolitan
          hubs such as Barcelona and Toronto, MiniBuy continues to enrich the
          lives of millions of consumers by providing them with delightful and
          high-quality lifestyle solutions.
        </p>
      </div>
    </>
  );
